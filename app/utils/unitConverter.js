...
const ratesMaps =
  {
    'https://api.coinmarketcap.com/v1/ticker/ethereum/?convert=DZD': {
      ...
      eth_eur: { path: { symbol: 'eth', key: 'price_dzd' }, name: 'DZD' },
    },

    'https://api.coinmarketcap.com/v1/ticker/?convert=DZD': {
